      ...
      "mcpServers": {
        "fltr": {
          ...
          "env": {
            ...
            "FLTR_AUTH_URL": "https://app.fltr.com/oauth/authorize"
          }
        }
      }
    }
...
const authUrl = `https://app.fltr.com/oauth/authorize?${params}`;
...
```bash
POST https://app.fltr.com/oauth/token
...
token_response = requests.post(
    'https://app.fltr.com/oauth/token',
    data={
        'grant_type': 'authorization_code',
        'code': auth_code,
        'client_id': 'YOUR_CLIENT_ID',
...
```javascript JavaScript
const response = await fetch('https://app.fltr.com/oauth/token', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded'
  },
...
AUTH_URL = 'https://app.fltr.com/oauth/authorize'
TOKEN_URL = 'https://app.fltr.com/oauth/token'
